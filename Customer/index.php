										...
										<table class="datatable table table-stripped">
											...
											<tbody>
												...
												$sql = "SELECT
                                                                ...
                                                                customer.phone,
                                                                customer.email,
                                                                customer.balance As credit,
                                                                SUM(
                                                                    airticket.cost1 + airticket.cost2 + airticket.cost3 + airticket.cost4 + airticket.cost5
                                                                ) AS debit   
                                                            FROM
                                                                airticket
                                                            INNER JOIN customer ON customer.CustomerId = airticket.csrId
                                                            GROUP BY
                                                                CustomerId
												...
												if ($result->num_rows > 0) {
  												while($row = $result->fetch_assoc()) {													  
													...
													echo "<tr><td>".$row["CustomerId"]."</td>
																...
																<td>".$row["phone"]."</td>
														 		<td>".$row["email"]."</td>
																<td><a href='EditCustomer.php?vId=$encryption' class='btn btn-primary'> View </a><td>
																 </tr>";   											
												  }
												} else {
