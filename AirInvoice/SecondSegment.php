...
$sql1 = "SELECT
                                ...
                                $paxName = $data['PaxName1'];
                                $pnrNo = $data['PNR1'];
                                $ticketNo = $data['TicketNo1'];
                                $airlinesNo = $data['Airlines1'];
                                $price1 = $data['cost1'];
                                $from = $data['placeFrom1'];
                                $to = $data['placeTo1'];
                                $way = $data['way1'];
                                $type = $data['ticketType1'];
                                $vprice = $data['vPrice1'];
                                $flightdatetime = $data['flight1'];
				...
				<!-- /Page Header -->
					...
					<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="text-danger card-title">Second Segment Invoice  Details</h4>
                     ...
                     <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="text-danger card-title">First Segment Details</h4>
									</div>
									<div class="card-body">
                                    ...
                                    <div class="row">
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="<?php echo $paxName ?>" class="form-control" disabled >
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label>PNR</label>
                                                                    <input type="text"  value="<?php echo $pnrNo ?>"  class="form-control" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label>Ticket No</label>
                                                                    <input type="text" value="<?php echo $ticketNo ?>" class="form-control"  disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="<?php echo $airlinesNo ?>" class="form-control"  disabled>
                                                                </div>
                                                            </div>                                                            
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="<?php echo $flightdatetime ?>" class="form-control"  disabled>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label>Way:</label>
                                                                    <input type="text" value="<?php echo $way ?>" class="form-control"  disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="<?php echo $vprice ?>" class="form-control"  disabled>
                                                                </div>
                                                            </div>													
                                                        </div>
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                                        <div class="col-md-2">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label>PNR</label>
                                                                    <input type="text" name="pnr1" value="<?php echo $pnrNo ?>"  class="form-control" >
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label>Ticket No</label>
                                                                    <input type="text" name="ticket1"value="<?php echo $ticketNo ?>" class="form-control"  required>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="way1" class="select form-control" >
                                                                            <option value="" disabled>Select Way</option>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label>Deal Price</label>                                                                    
                                                                            <input type='number' name='price1' value='<?php echo $price1; ?>' class='form-control'  disabled> 
                         ...
                         <?php
                                ...
                                function(){
                                    window.location=\'SecondSegmentInvoice.php?INV='.$INV_No.'\'
                                    });
                                </script>';
