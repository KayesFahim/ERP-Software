                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="first.php"><i class="fe fe-layout"></i> <span>First Page</span></a>
							</li>
							<li> 
								<a href="second.php"><i class="fe fe-layout"></i> <span>Second Page</span></a>
							</li>
							<li> 
								<a href="third.php"><i class="fe fe-layout"></i> <span>Third Page</span></a>
							</li>
							<li> 
								<a href="fourth.php"><i class="fe fe-layout"></i> <span>Fourth Page</span></a>
							</li>
							<li> 
								<a href="fifth.php"><i class="fe fe-layout"></i> <span>Fifth Page</span></a>
							</li>
