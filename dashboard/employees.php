				...
				<div class="page-header">
					<div class="row">
						<div class="col-sm-12">
							...
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="Employees.html">Dashboard</a></li>
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="text-right">
										<a href="employeeDetails.php" class="btn btn-primary"> Add +</a>
									</div>
								</div>
									...
									<div class="table-responsive">
										<table class="datatable table table-stripped">
											...
											<tbody>
												...
												$sql = "SELECT id, EMP_ID, email, name, phone, department FROM employee";
												...
												if ($result->num_rows > 0) {
  												while($row = $result->fetch_assoc()) {
													...
													echo "<tr><td>".$row["EMP_ID"]."</td>
																...
																<td><a href='employeeDetails.php' class='btn btn-primary'> View </a><td>
																 </tr>";   											
												  }
												} else {
  												echo "0 results";
