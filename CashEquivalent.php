									...
									<div class="table-responsive">
										<table class="datatable table table-stripped">
											...
											<tbody>
												...
												<tr><td>FFI-1002</td>
																<td>Ashik Rahman</td> 
														 		<td>ashik@flyfarint.com</td>
																<td>01755572098</td>
														 		<td>Creative</td>
																<td><a href='UpdateEmployee.php?empId=O7EEkhkcRvg=' class='btn btn-primary'> View </a><td>
																 </tr><tr><td>FFI-1001</td>
																<td>Ahmed Ali</td> 
														 		<td>ali@flyfarint.com</td>
																<td>01755572096</td>
														 		<td>Creative</td>
																<td><a href='UpdateEmployee.php?empId=O7EEkhkcRvs=' class='btn btn-primary'> View </a><td>
																 </tr><tr><td>FFI-1000</td>
																<td>Kayes Hossan Fuad</td> 
														 		<td>fahim@flyfarint.com</td>
																<td>01322903298</td>
														 		<td>Fly Far Tech</td>
																<td><a href='UpdateEmployee.php?empId=O7EEkhkcRvo=' class='btn btn-primary'> View </a><td>
																 </tr>
